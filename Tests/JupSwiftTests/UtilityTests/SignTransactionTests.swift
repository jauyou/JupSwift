...
struct SolanaWalletTests {
    ...
    func testSignTransaction() throws {
        ...
        var signedTransactionBase64 = try signTransaction(base64Transaction: base64Transaction, privateKey: privateKey)
        ...
        signedTransactionBase64 = try signTransaction(base64Transaction: base64Transaction, privateKey: base58Str)
